...
type CreateOrder struct {
	...
	Recipient     model.Address        `json:"recipient" bson:"recipient"  mapstructure:"recipient"`
	OrderItems    []model.CatalogItem  `json:"order_items" bson:"order_items"  mapstructure:"order_items"`
